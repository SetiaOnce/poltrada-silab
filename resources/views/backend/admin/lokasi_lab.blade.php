@extends('backend.layouts', ['activeMenu' => 'LOKASI_LABORATORIUM', 'activeSubMenu' => '', 'title' => 'Lokasi Laboratorium'])
@section('content')
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-sm btn btn-bg-light btn-color-danger me-2" id="btn-closeForm" onclick="_closeCard('form_lokasi_lab');"><i class="fas fa-times"></i> Tutup</button>
            </div>
        </div>
    </div>
    <!--end::Card header-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12">
                    ...
                    <div class="form-group mt-4">
                        <label class="col-form-label required fs-6" for="nama_lokasi">Nama Lokasi</label>
                        <input type="text" name="nama_lokasi" id="nama_lokasi" class="form-control form-control-lg mb-3 mb-lg-0 " maxlength="120" placeholder="Isikan nama lokasi ..." />
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Lokasi Laboratorium
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered nowrap border" id="dt-lokasiLab">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-light">
                        <th class="text-center align-middle px-2 border-bottom-2 border-gray-200">No.</th>
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">Nama Lokasi</th>
...
<script src="{{ asset('/script/backend/admin/lokasi_lab.js') }}"></script>
@stop
@endsection