@extends('backend.layouts', ['activeMenu' => 'BANNERS', 'activeSubMenu' => 'settings', 'title' => 'Banners Perpustakaan'])
@section('content')
...
<div class="card" id="card-form" style="display: none;">
    ...
    <form id="form-data" class="form" onsubmit="return false">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12">
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6" id="iGroup-file_image">
                        <label class="col-form-label required fw-bold fs-6">File Banner</label>
                        <input type="file" class="dropify-upl mb-3 mb-lg-0" id="file_image" name="file_image" accept=".png, .jpg, .jpeg" data-show-remove="false" data-allowed-file-extensions="jpg png jpeg" data-max-file-size="2M" />
                        <div class="form-text">*) Type file: <code>*.jpeg | *.jpeg | *.png</code></div>
                        <div class="form-text">*) Max. size file: <code>2MB</code></div>
                        <div class="form-text">*) Rekomendasi gambar banner: <small class="text-info">W=2610px</small> dan <small class="text-info">H=700px</small> </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
        ...
        <div class="card-footer d-flex justify-content-end py-6 px-9">
            ...
            <button type="button" id="btn-reset" class="btn btn-sm btn-secondary" onclick="_clearForm();"><i class="bi bi-arrow-clockwise fs-3"></i> Batal</button>
        </div>
        <!--end::Actions-->
    </form>
    <!--end::Form-->
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Konten Banner
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded align-middle table-row-bordered border" id="dt-banners">
                <thead>
...
<script src="{{ asset('/script/backend/admin/banners.js') }}"></script>
@stop
@endsection