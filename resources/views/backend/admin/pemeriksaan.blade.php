@extends('backend.layouts', ['activeMenu' => 'PEMERIKSAAN', 'activeSubMenu' => 'alatperaga', 'title' => 'Data Pemeriksaan Alat'])
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10 col-sm-12">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" name="tgl_pemeriksaan" id="tgl_pemeriksaan" class="form-control mb-3 mb-lg-0 " maxlength="250" placeholder="Isikan tanggal pemeriksaan ..." />
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Pemeriksaan Alat Peraga
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered border gy-3 gs-3" id="dt-pemeriksaanAlat">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-dark text-light">
                        ...
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">Tgl.Pemeriksaan</th>
...
<script src="{{ asset('/script/backend/admin/pemeriksaan.js') }}"></script>
@stop
@endsection