@extends('backend.layouts', ['activeMenu' => 'LAPORAN_BUKU_TAMU', 'activeSubMenu' => 'laporan', 'title' => 'Data Buku Tamu'])
@section('content')
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Buku Tamu
            </h3>
        </div>
            ...
            <div class="d-flex justify-content-end">
                <div class="m-0 me-2">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-350px w-md-400px" data-kt-menu="true" id="kt_menu_64e5cdce6c4af" style="">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">Filter Data Buku Tamu</div>
                        </div>
                        <!--end::Header-->
                        ...
                        <!--begin::Form-->
                        <div class="px-7 py-5">
                            <label class="col-form-label fs-6 ">Range Tanggal Kunjungan</label>
                            <!--begin::Input group-->
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered nowrap border" id="dt-bukuTamu">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-light">
                        <th class="text-center align-middle px-2 border-bottom-2 border-gray-200">No.</th>
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">NAMA INSTANSI</th>
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">NAMA KEGIATAN</th>
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">TANGGAL KUNJUNGAN</th>
                        <th class="text-center align-middle px-2 border-bottom-2 border-gray-200">FOTO</th>
                    </tr>
                </thead>
...
<script src="{{ asset('/script/backend/common/data_buku_tamu.js') }}"></script>
@stop
@endsection