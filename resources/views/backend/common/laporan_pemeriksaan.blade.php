@extends('backend.layouts', ['activeMenu' => 'LAPORAN_PEMERIKSAAN', 'activeSubMenu' => 'laporan', 'title' => 'Laporan Pemeriksaan'])
@section('content')
            ...
            <div class="d-flex justify-content-end">
                <div class="m-0 me-2">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-350px w-md-400px" data-kt-menu="true" id="kt_menu_64e5cdce6c4af" style="">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">Filter Data Pemeriksaan</div>
                        </div>
                        <!--end::Header-->
                        ...
                        <!--begin::Form-->
                        <div class="px-7 py-5">
                            <label class="col-form-label fs-6 ">Range Tanggal Pemeriksaan</label>
                            <!--begin::Input group-->
...
<script src="{{ asset('/script/backend/common/laporan_pemeriksaan.js') }}"></script>
@stop
@endsection