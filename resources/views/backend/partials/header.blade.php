                    ...
                    <div class="d-flex align-items-stretch">
                        <div class="d-flex align-items-center">
                            <a href="{{ url('/') }}" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Lihat halaman publik" target="_blank">
                                <i class="bi bi-box-arrow-up-right fs-2 fs-lg-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ url('app_admin/profile_user') }}" class="menu-link px-5 ">
                                <i class="bi bi-person-circle fs-3 me-3"></i> Profile Saya
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ url('/logout') }}" class="menu-link px-5 text-danger">
                                <i class="bi bi-power fs-3 me-3 text-danger"></i> Sign Out
                            </a>
                        </div>
                        <!--end::Menu item-->
                    </div>
